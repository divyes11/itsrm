                ...
                <form action="" method="post">
                    ...
                    <div>
                            <tr>
                                ...
                                <td><input type="text" class="iptemt form-control"  name="mac" value="<?php echo $row['mac_address']; ?>"; required><a href="find_mac_help.php"><input type="hidden"   name="helpmac" value="Find Mac add" required></a></td>
                            </tr>
                    </div>
                    <div>
                            <tr>
                                <td><label for="ip" class="label">IP Address:</label></td>
                                <td><input type="text" class="iptemt form-control" name="ip" required><a href="find_ip_addres_help.php"><input type="hidden"   name="helpIp" value="Find IP add" required></a></td>
                            </tr>
                       </div>
                       ...
                       <div>
                            <tr>
                                ...
                                <td><input type="text" class="iptemt form-control" name="username"  required></td> 
                        ...
                        <div>
                            <tr>
                                ...
                                <td><input type="password" class="iptemt form-control"  name="password" required></td>
                            </tr>
                       </div>
                       
        
                            <tr>
                                <td><input type="submit" class="btn"  id="rsubmit"  
...
{   
   ...
   $sq ="UPDATE `tbl_connection` SET `ip_address`='$ip',`username`='$username',`password`='$password',`mac_address`='$mac_address' ,`approve` =3 WHERE `email_id`='$email' and connection_type='wifi' ";
