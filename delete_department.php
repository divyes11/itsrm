			    ...
			    <div class="app-card alert alert-dismissible shadow-sm mb-4 border-left-decoration" role="alert">
				    <div class="inner">
					    <div class="app-card-body p-3 p-lg-4">
						    <h3 class="mb-3">Delete Department</h3>
    ...
    <body>
        ...
        <!-- <div id="formdiv"> -->
            ...
            <!-- <div> -->
                    ...
                    <tr>
                        <td><B><label for="department_name">  Deparment id :</label></B></td>
                        <td><input  class="iptemt" type="TEXT"  name="deparment_id"   placeholder="Enter department id"></td>
...
// $row=mysqli_fetch_assoc($result);
	...
	{
        $dep_id =$_POST['deparment_id'];

        $qurey="DELETE FROM `tbl_department` WHERE dep_id=$dep_id;";
        
        

        if($res=mysqli_query($conn,$qurey))
        {
            echo "<script>alert('department  delete succesfully');</script>";
        }
