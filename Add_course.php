    ...
    <body>
        ...
        <!-- <div id="formdiv"> -->
            ...
            <!-- <div> -->
                    ...
                    <tr>
                        <td><B><label for="department_name">  Course name :</label></B></td>
                        <td><input  class="iptemt" type="TEXT"  name="course_name"   placeholder="Enter Course Name"></td>
...
// $row=mysqli_fetch_assoc($result);
    ...
    if(isset($_POST['submit']))
	{
        ...
        $qurey="INSERT INTO `tbl_course`( `course`) VALUES ('$course')";
        

        if($res=mysqli_query($conn,$qurey))
        {
            echo "<script>alert('Course  save succesfully');</script>";
        }
